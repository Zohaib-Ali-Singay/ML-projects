...
if user_menu == 'Athlete-wise Analysis':
    ...
    famous_sports = ["Basketball", "Judo", "Football", "Tug-of-War", "Athletics",
                    "Swimming", "Badminton", "Sailing", "Gymnastics", "Art Competitions", "Handball", "Weightlifting",
                    "Wrestling", "Water Polo", "Hockey", "Rowing", "Fencing", "Shooting", "Boxing", "Taekwando",
    ...
    for sport in famous_sports:
        ...
        if not gold_ages.empty: # We are doing it bcz there are many sports for which no gold-medal is won
            x.append(gold_ages)
            name.append(sport)
    ...
    famous_sport = st.selectbox("Select a Sport", sport_list)
  
    temp_df = helper.wieght_v_height(df, famous_sport)
